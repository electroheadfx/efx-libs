 ...
 * EfxLayout Presets
 *
 * Pre-defined layout templates for common dashboard patterns.
 */

import type { Breakpoint, LayoutTemplate } from './types'
...
export const LAYOUT_PRESETS = {
  ...
  /** Page with title header and content area */
  pageWithTitle: {
    areas: `
      "title"
      "content"
  ...
  /** Page with title header, controls bar, and content area */
  pageWithControls: {
    areas: `
      "title"
      "controls"
...
export const RESPONSIVE_LAYOUTS = {
  ...
  pageWithTitle: {
    ...
    desktop: LAYOUT_PRESETS.pageWithTitle,
  },
} satisfies Record<string, Partial<Record<Breakpoint, LayoutTemplate>>>

export type ResponsiveLayoutName = keyof typeof RESPONSIVE_LAYOUTS

...
export function LayoutNavigator({
  ...
  if (compact) {
    return (
      <div className={`h-full flex items-center justify-between px-3 bg-rs-bg-card border border-rs-border rounded-lg ${className}`}>
        <button
          type="button"
  ...
  return (
    <div className={`p-4 bg-rs-bg-card border border-rs-border rounded-lg ${className}`}>

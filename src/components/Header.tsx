...
function ThemeDropdown() {
  ...
  // Wait for client-side hydration before showing theme-dependent icon
  useEffect(() => {
    setMounted(true)
  }, [])
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        {/* Show Sun icon during SSR, actual theme icon after hydration */}
        {mounted ? <CurrentIcon size={18} /> : <Sun size={18} />}
        <ChevronDown
          size={14}
